...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'infuraNftApiDashboardNestJs';
    ...
    'jhipster.mail.from' = 'infuraNftApiDashboardNestJs@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'infuraNftApiDashboardNestJs API';
    'jhipster.swagger.description' = 'infuraNftApiDashboardNestJs API documentation';
    ...
    'eureka.instance.appname' = 'infuraNftApiDashboardNestJs';
    'eureka.instance.instanceId' = 'infuraNftApiDashboardNestJs:${random.value}';
    ...
    'cloud.config.name' = 'infuraNftApiDashboardNestJs';
