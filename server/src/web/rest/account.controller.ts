...
export class AccountController {
    ...
    @ApiOperation({ description: 'Activate an account' })
    @ApiResponse({
        status: 200,
    ...
    @ApiBearerAuth()
    @UseGuards(AuthGuard)
    @ApiOperation({ description: 'Update the current user information' })
    @ApiResponse({
        status: 201,
    ...
    @ApiBearerAuth()
    @UseGuards(AuthGuard)
    @ApiOperation({ description: 'Change current password' })
    @ApiResponse({
        status: 201,
    ...
    @ApiBearerAuth()
    @UseGuards(AuthGuard)
    @ApiOperation({ description: 'Send an email to reset the password of the user' })
    @ApiResponse({
        status: 201,
    ...
    @ApiBearerAuth()
    @UseGuards(AuthGuard)
    @ApiOperation({ description: 'Finish to reset the password of the user' })
    @ApiResponse({
        status: 201,
